...
public class BatchOnlyJdbcReaderTestConfiguration {
	...
	@Bean
	@StepScope
	public JdbcPagingItemReader<PassEntity> batchOnlyJdbcReaderTestJobReader(
		...
		return new JdbcPagingItemReaderBuilder<PassEntity>()
				.name("batchOnlyJdbcReaderTestJobReader")
				.pageSize(chunkSize)
				.fetchSize(chunkSize)
				.dataSource(dataSource)
				.rowMapper(new BeanPropertyRowMapper<>(PassEntity.class))
